...
from utils.tsne_reducer import tsne
from utils.umap_reducer import umap
...
def main(argv):
    ...
    parser.add_argument('--reduce', '-r', help='[tsne/umap]: How many dimensions to reduce features to. Default is 2.',
                        default='2')
    parser.add_argument('--model', '-m',
                        help='[features]: Which model to use. ResNet50 | Xception | VGG16 | VGG19 | InceptionV3 | MobileNet. Default: ResNet50',
                        default='ResNet50')
    ...
    if args.mode == 'features':
        ...
        extract_features(args.data, model=args.model, write_to=args.out)
